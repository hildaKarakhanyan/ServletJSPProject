...
import com.synergy.training.entities.Database;
...
public class AddEditServlet extends HttpServlet {
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if(id > 0) {
            Database.editProject(id, title, desc, totalAmount, currencyId, subSector);
        } else {
            Database.addProject(id, title, desc, totalAmount, currencyId, subSector);
        }
